    ...
    <div className={containerClass}>
      ...
      <div className="px-6 py-4 bg-slate-900/80 border-b border-slate-800 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-amber-500 to-orange-500 flex items-center justify-center text-slate-950 font-bold shadow-lg">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/30 rounded-xl text-xs font-semibold transition-all"
          >
          ...
          <div className="p-4 border-b border-slate-800">
            <div className="relative">
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 focus:border-amber-500/80 rounded-xl pl-9 pr-4 py-2 text-xs text-slate-100 outline-none placeholder:text-slate-500"
              />
                ...
                return (
                  ...
                  >
                    ...
                    {visitor.unread_admin > 0 && (
                      <span className="bg-rose-500 text-white font-bold text-[10px] px-2 py-0.5 rounded-full flex-shrink-0">
          ...
          {selectedVisitor ? (
            <>
              ...
              <div className="flex-1 p-6 overflow-y-auto space-y-4">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-end gap-2 max-w-[75%]">
                          {!isAdmin && (
                            <div className="w-7 h-7 rounded-full bg-slate-800 text-amber-400 font-bold text-xs flex items-center justify-center border border-slate-700 flex-shrink-0 mb-1">
                              {selectedVisitor.pseudo.charAt(0).toUpperCase()}
                            </div>
                          )}
                          <div
                        ...
                        <span className="text-[10px] text-slate-500 mt-1 px-1 flex items-center gap-1">
                          {timeStr} {isAdmin && <CheckCheck className="w-3 h-3 text-amber-500" />}
                        </span>
                      </div>
                    );
                  })
                ...
                {isVisitorTyping && (
                  <div className="flex items-center gap-2 text-xs text-amber-400 italic bg-amber-500/10 p-2.5 rounded-xl w-fit border border-amber-500/20 animate-pulse">
              ...
              >
                <input
                  ...
                  className="flex-1 bg-slate-950 border border-slate-800 focus:border-amber-500 rounded-xl px-4 py-3 text-xs text-slate-100 outline-none transition-all placeholder:text-slate-500"
                />
                <button
                  type="submit"
                  disabled={!inputMessage.trim()}
                  className="px-5 py-3 bg-amber-500 hover:bg-amber-400 disabled:bg-slate-800 disabled:text-slate-600 text-slate-950 font-bold rounded-xl text-xs transition-all shadow-lg flex items-center gap-2"
                >
            ...
            <div className="h-full flex flex-col items-center justify-center text-slate-500 p-8 space-y-3">
              <MessageSquare className="w-12 h-12 opacity-30 text-amber-500" />
