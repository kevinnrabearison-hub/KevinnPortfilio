    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 font-sans">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8 space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-tr from-amber-500 to-orange-500 shadow-2xl shadow-amber-500/30 text-slate-950 mb-2">
        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl overflow-hidden">
          <div className="px-6 py-5 bg-gradient-to-r from-slate-950 via-slate-900/80 to-indigo-950/40 border-b border-slate-800">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-800 focus:border-amber-500/80 rounded-xl px-4 py-3 pr-11 text-sm text-slate-100 outline-none transition-all placeholder:text-slate-600"
                  autoFocus
                />
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 text-slate-950 font-bold rounded-xl text-sm shadow-lg shadow-amber-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
